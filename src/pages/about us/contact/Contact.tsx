...
const Contact = () => {
    return (
        ...
        <h2 className="text-2xl font-bold text-center hover:text-[#CB1836]">Contact Information</h2>
        
        <div className="space-y-6">
          <div className="flex items-center">
            <FaPhone className="text-[#CB1836] text-2xl mr-4" />
            <div>
          ...
          <div className="flex items-center">
            <FaEnvelope className="text-[#CB1836] text-2xl mr-4" />
            <div>
          ...
          <div className="flex items-center">
            <FaMapMarkerAlt className="text-[#CB1836] text-2xl mr-4" />
            <div>
        ...
        <div className="space-y-4">
          <h3 className="text-2xl font-bold text-center hover:text-[#CB1836]">Follow Us</h3>

...
const Mission = () => {
    return (
      ...
      <div className="max-w-screen-lg mx-auto text-center">
        <h2 className="text-2xl font-bold mb-4 hover:text-[#CB1836]">Our Mission</h2>
        <p className="text-gray-700 text-lg mb-6">
          To provide high-quality outdoor products that inspire adventure and foster a love for nature.
        </p>
        <h2 className="text-2xl font-bold mb-4 hover:text-[#CB1836]">Core Values</h2>
        <ul className="text-left max-w-lg mx-auto space-y-4">
          <li className="flex items-center">
            <span className="bg-[#CB1836] text-white rounded-full w-8 h-8 flex items-center justify-center mr-4">
              1
            </span>
